...
1. docker network create quacker-network
2. docker build -t quacker .
3. docker run -d network quacker-network -p 27017:27017 --name mongodb mongo:4.4.18
4. docker run -d network quacker-network -p 5000:5000 quacker
